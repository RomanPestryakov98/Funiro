(() => {
    ...
    function clickOpenSearch() {
        document.querySelector(".actions-header__button-search").addEventListener("click", (function() {
            document.querySelector(".actions-header__button-search").classList.toggle("actions-header__button-search_active");
    ...
    function initSliders() {
        if (document.querySelector(".main-slider__slider")) new core(".main-slider__slider", {
            ...
            pagination: {
                el: ".main-slider__controls .main-slider__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".main-slider__controls .main-slider__arrow_type_prev",
                nextEl: ".main-slider__controls .main-slider__arrow_type_next"
            },
            on: {}
        });
        if (document.querySelector(".slider-rooms__slider")) new core(".slider-rooms__slider", {
            ...
            navigation: {
                prevEl: ".slider-rooms__arrow_type_prev",
                nextEl: ".slider-rooms__arrow_type_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".slider-tips-tricks__slider")) new core(".slider-tips-tricks__slider", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            pagination: {
                el: ".slider-tips-tricks__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-tips-tricks__arrow_type_prev",
                nextEl: ".slider-tips-tricks__arrow_type_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".card-header__icon")) {
                ...
                e.preventDefault();
            } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains('"popup-card__button')) document.querySelector(".cart-header").classList.remove("_active");
        ...
        function updateCart(button, productId, productAdd = true) {
            ...
            if (productAdd) {
                if (quanity) quanity.innerHTML = ++quanity.innerHTML; else cartIcon.insertAdjacentHTML("beforeend", `<span>1</span>`);
                if (!cartProduct) {
                    const product = document.querySelector(`[data-id="${productId}"]`);
                ...
                const cartProductQuanity = cartProduct.querySelector(".cart-list__quanity span");
                cartProductQuanity.innerHTML = --cartProductQuanity.innerHTML;
                if (!parseInt(cartProductQuanity.innerHTML)) cartProduct.remove();
                const cartQuanityValue = --quanity.innerHTML;
                if (cartQuanityValue) cartQuanityValue.innerHTML = cartQuanityValue; else {
                    quanity.remove();
